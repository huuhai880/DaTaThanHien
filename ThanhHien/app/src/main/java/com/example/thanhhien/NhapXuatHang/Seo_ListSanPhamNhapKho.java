    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridViewListQuyCach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Seo_ListSanPhamNhapKho.this, ""+position, Toast.LENGTH_SHORT).show();
        ...
        btnGioHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Seo_ListSanPhamNhapKho.this, "Xem giỏ hàng", Toast.LENGTH_SHORT).show();
            }
        });
